...
$nama = $fecth['nama'];
$username = $fecth['username'];
$nik = $fecth['nik'];
$tgl_lahir = $fecth['tgl_lahir'];
$jenis_kelamin = $fecth['jenis_kelamin'];
$pekerjaan = $fecth['pekerjaan'];
$alamat = $fecth['alamat'];
$email = $fecth['email'];
$no_hp = $fecth['no_hp'];
$waktu = $fecth['waktu'];
...
<body>
<div class="col-lg-12">
        <h1>Profil Data<small> Anggota</small></h1>
        <ol class="breadcrumb">
    ...
    <table class="table table-striped ">
        ...
        <tr bgcolor="#DFE6EF" height="30">
            <td>&nbsp;</td>
            <td><b>Selamat Datang <u><i><?=$nama?></i></u></b></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
			<td>&nbsp;</td>
