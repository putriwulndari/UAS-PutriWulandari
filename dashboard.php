...
$sqltabungan = mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(jlh_tabungan + jlh_sukarela) AS jlh_tabungan FROM tabungan"));
$sqlpinjaman = mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(jlh_pinjam) AS jlh_pinjam FROM pinjaman "));
