...
include("config.php");
  if (isset($_POST['simpan']) ) {
	...
	if (mysqli_num_rows($check) > 0){
        ...
        $inputuser	="INSERT INTO users (username,password, entry ,akses, status) VALUES ('$username' ,'$password', '$entry', '$akses', 'aktif')";
	...
	if ($queryanggota ){
        ...
        echo '<script>window.location="indexadmin.php?page=inputanggota";</script>';
